...
/**
 * The RHU dashboard from the medjofinal reference: two KPI cards on the left,
 * the two progress rings stacked on the right, and the recent-activity strip
 * beneath. Every figure arrives from RhuController::dashboard()'s live
 * queries — the page holds no sample data of its own.
 */
...
function TrackerRing({ progress }) {
    ...
    // patients; diagnostic assessment counts the one required test each
    // patient needs, exactly as the Patient Tracker itself does.
    return (
        <ProgressDonut
